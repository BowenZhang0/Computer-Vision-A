...
[[3. 5. 0.]
 [5. 0. 0.]]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{n}{C}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{1} \PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}
         \PY{n}{D} \PY{o}{=} \PY{n}{C}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{C}\PY{o}{.}\PY{n}{ndim}\PY{p}{)}
...
[[1]
 ...
 [3]]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{matrix\PYZus{}rank}\PY{p}{(}\PY{n}{D}\PY{p}{)}
\end{Verbatim}
...
Image shape (512, 512, 3)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}29}]:} \PY{n+nb}{print}\PY{p}{(}\PY{n}{img}\PY{p}{[}\PY{l+m+mi}{511}\PY{p}{,}\PY{l+m+mi}{400}\PY{p}{]}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{matrix\PYZus{}rank}\PY{p}{(}\PY{n}{img}\PY{p}{[}\PY{l+m+mi}{511}\PY{p}{,}\PY{l+m+mi}{400}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{matrix\PYZus{}rank}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
1
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{k}{def} \PY{n+nf}{iterative}\PY{p}{(}\PY{n}{img}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{c+c1}{\PYZsh{} The code for this problem is posted on Piazza. Sign up for the course if you have not. Then find}
         \PY{c+c1}{\PYZsh{} the function definition included in the post \PYZsq{}Welcome to CSE252A\PYZsq{} to complete this problem.}
         \PY{c+c1}{\PYZsh{} This is the only cell you need to edit for this problem.}
...
Vectorized method took 0.007898807525634766 seconds
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{c+c1}{\PYZsh{} Plotting the results in sepearate subplots}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{\PYZsh{} Write your code here. Import the image and define the required funtions.}
        ...
        \PY{k}{def} \PY{n+nf}{getChannel}\PY{p}{(}\PY{n}{image}\PY{p}{,}\PY{n}{channel}\PY{p}{)}\PY{p}{:}
            \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}Function for extracting 2D image corresponding to a channel number from a color image\PYZsq{}\PYZsq{}\PYZsq{}}
            \PY{n}{image} \PY{o}{=} \PY{n}{copy}\PY{o}{.}\PY{n}{deepcopy}\PY{p}{(}\PY{n}{image}\PY{p}{)}     \PY{c+c1}{\PYZsh{}Create a copy so as to not change the original image}
            \PY{n}{image} \PY{o}{=} \PY{n}{image}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{n}{channel}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{c+c1}{\PYZsh{}plt.imshow(image)                           \PYZsh{} displaying the original image}
        ...
        \PY{k}{def} \PY{n+nf}{mergeChannels}\PY{p}{(}\PY{n}{image1}\PY{p}{,}\PY{n}{image2}\PY{p}{,}\PY{n}{image3}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{image}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{n+nb}{int}\PY{p}{(}\PY{n}{image1}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{,}\PY{n+nb}{int}\PY{p}{(}\PY{n}{image1}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{)}
            \PY{n}{image}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{=}\PY{n}{image1}
            \PY{n}{image}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{=}\PY{n}{image2}
            \PY{n}{image}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{]}\PY{o}{=}\PY{n}{image3}
            \PY{c+c1}{\PYZsh{}plt.imshow(image)                           \PYZsh{} displaying the original image}
            \PY{c+c1}{\PYZsh{}plt.show()}
            \PY{k}{return} \PY{n}{image}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{} Test your function}
        ...
        \PY{k}{assert} \PY{n+nb}{len}\PY{p}{(}\PY{n}{mergeChannels}\PY{p}{(}\PY{n}{getChannel}\PY{p}{(}\PY{n}{image}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{,}\PY{n}{getChannel}\PY{p}{(}\PY{n}{image}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,}\PY{n}{getChannel}\PY{p}{(}\PY{n}{image}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{)}\PY{o}{.}\PY{n}{shape}\PY{p}{)} \PY{o}{==} \PY{l+m+mi}{3}
        \PY{c+c1}{\PYZsh{}swap red channel with blue channel}
        \PY{k}{assert} \PY{n+nb}{len}\PY{p}{(}\PY{n}{mergeChannels}\PY{p}{(}\PY{n}{getChannel}\PY{p}{(}\PY{n}{image}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{,}\PY{n}{getChannel}\PY{p}{(}\PY{n}{image}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,}\PY{n}{getChannel}\PY{p}{(}\PY{n}{image}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}\PY{o}{.}\PY{n}{shape}\PY{p}{)} \PY{o}{==} \PY{l+m+mi}{3}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}28}]:} \PY{c+c1}{\PYZsh{} Write your code here for tiling the six images to make a single image and displaying it. }
         \PY{c+c1}{\PYZsh{} Notice that the images returned by getChannel will be 2 dimensional, }
         \PY{c+c1}{\PYZsh{} To tile them together with RGB images, you might need to change it to a 3 dimensional image.}
         \PY{c+c1}{\PYZsh{} This can be done using np.expand\PYZus{}dims and specifying the axis as an argument.}
         \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
         \PY{l+s+sd}{R = getChannel(image,1)}
         \PY{l+s+sd}{G = getChannel(image,2)}
         \PY{l+s+sd}{B = getChannel(image,3)}
         \PY{l+s+sd}{RGB = mergeChannels(R,G,B)}
         \PY{l+s+sd}{BGR = mergeChannels(B,G,R)}
         
         \PY{l+s+sd}{R\PYZus{}1 = np.expand\PYZus{}dims(R, axis=2)}
         \PY{l+s+sd}{G\PYZus{}1 = np.expand\PYZus{}dims(G, axis=2)}
         \PY{l+s+sd}{B\PYZus{}1 = np.expand\PYZus{}dims(B, axis=2)}
         
         
         \PY{l+s+sd}{image\PYZus{}1 = copy.deepcopy(image)}
         \PY{l+s+sd}{a = int(image.shape[0]/3)}
         \PY{l+s+sd}{b = int(image.shape[1]/2)}
         \PY{l+s+sd}{image\PYZus{}1[:a,:b] = R\PYZus{}1[:a,:b]}
         \PY{l+s+sd}{image\PYZus{}1[a:2*a,:b] = B\PYZus{}1[a:2*a,:b]}
         \PY{l+s+sd}{\PYZsh{}image[2*a:,:b] = G[2*a:,:b]}
         \PY{l+s+sd}{image\PYZus{}1[:a,b:] = G\PYZus{}1[:a,b:]}
         \PY{l+s+sd}{image\PYZus{}1[a:2*a,b:] = RGB[a:2*a,b:]}
         \PY{l+s+sd}{image\PYZus{}1[2*a:,b:] = BGR[2*a:,b:]}
         \PY{l+s+sd}{plt.imshow(image\PYZus{}1)                           \PYZsh{} displaying the original image}
         \PY{l+s+sd}{plt.show()}
         \PY{l+s+sd}{    \PYZsh{}print(image.s}
         \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{n}{R} \PY{o}{=} \PY{n}{getChannel}\PY{p}{(}\PY{n}{image}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}
        \PY{n}{G} \PY{o}{=} \PY{n}{getChannel}\PY{p}{(}\PY{n}{image}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{)}
        \PY{n}{B} \PY{o}{=} \PY{n}{getChannel}\PY{p}{(}\PY{n}{image}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{)}
        \PY{n}{RGB} \PY{o}{=} \PY{n}{mergeChannels}\PY{p}{(}\PY{n}{R}\PY{p}{,}\PY{n}{G}\PY{p}{,}\PY{n}{B}\PY{p}{)}
        \PY{n}{BGR} \PY{o}{=} \PY{n}{mergeChannels}\PY{p}{(}\PY{n}{B}\PY{p}{,}\PY{n}{G}\PY{p}{,}\PY{n}{R}\PY{p}{)}
        
        \PY{n}{R\PYZus{}1} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{expand\PYZus{}dims}\PY{p}{(}\PY{n}{R}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{)}
        \PY{n}{G\PYZus{}1} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{expand\PYZus{}dims}\PY{p}{(}\PY{n}{G}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{)}
        \PY{n}{B\PYZus{}1} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{expand\PYZus{}dims}\PY{p}{(}\PY{n}{B}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{Z} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{512}\PY{p}{,}\PY{l+m+mi}{512}\PY{p}{]}\PY{p}{)}
         \PY{n}{RGB\PYZus{}R} \PY{o}{=} \PY{n}{mergeChannels}\PY{p}{(}\PY{n}{R}\PY{p}{,}\PY{n}{Z}\PY{p}{,}\PY{n}{Z}\PY{p}{)}
         \PY{n}{RGB\PYZus{}G} \PY{o}{=} \PY{n}{mergeChannels}\PY{p}{(}\PY{n}{Z}\PY{p}{,}\PY{n}{G}\PY{p}{,}\PY{n}{Z}\PY{p}{)}
         \PY{n}{RGB\PYZus{}B} \PY{o}{=} \PY{n}{mergeChannels}\PY{p}{(}\PY{n}{Z}\PY{p}{,}\PY{n}{Z}\PY{p}{,}\PY{n}{B}\PY{p}{)}
         
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{RGB\PYZus{}R}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{RGB\PYZus{}G}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{RGB\PYZus{}B}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
\end{Verbatim}
...
(512, 512, 3)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{n}{a}\PY{o}{=}\PY{l+m+mi}{512}
         \PY{n}{b}\PY{o}{=}\PY{l+m+mi}{512}
         \PY{n}{image\PYZus{}2} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{2}\PY{o}{*}\PY{l+m+mi}{512}\PY{p}{,}\PY{l+m+mi}{3}\PY{o}{*}\PY{l+m+mi}{512}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{]}\PY{p}{)}
         \PY{c+c1}{\PYZsh{}image\PYZus{}2\PYZus{}ex = np.expand\PYZus{}dims(image\PYZus{}2, axis=2)}
         \PY{n}{image\PYZus{}2}\PY{p}{[}\PY{p}{:}\PY{n}{a}\PY{p}{,}\PY{p}{:}\PY{n}{b}\PY{p}{]} \PY{o}{=} \PY{n}{RGB\PYZus{}R}
         \PY{n}{image\PYZus{}2}\PY{p}{[}\PY{p}{:}\PY{n}{a}\PY{p}{,}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{b}\PY{p}{:}\PY{p}{]} \PY{o}{=} \PY{n}{RGB\PYZus{}B}
         \PY{c+c1}{\PYZsh{}image[2*a:,:b] = G[2*a:,:b]}
         \PY{n}{image\PYZus{}2}\PY{p}{[}\PY{p}{:}\PY{n}{a}\PY{p}{,}\PY{n}{b}\PY{p}{:}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{b}\PY{p}{]} \PY{o}{=} \PY{n}{RGB\PYZus{}G}
         \PY{n}{image\PYZus{}2}\PY{p}{[}\PY{n}{a}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{b}\PY{p}{:}\PY{p}{]} \PY{o}{=} \PY{n}{RGB}
         \PY{n}{image\PYZus{}2}\PY{p}{[}\PY{n}{a}\PY{p}{:}\PY{p}{,}\PY{n}{b}\PY{p}{:}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{b}\PY{p}{]} \PY{o}{=} \PY{n}{BGR}
         \PY{n}{image\PYZus{}2}\PY{p}{[}\PY{n}{a}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{n}{b}\PY{p}{]}\PY{o}{=}\PY{n}{image}
         \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image\PYZus{}2}\PY{p}{)}                     
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
