...
{\color{incolor}In [{\color{incolor}2}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np}
        ...
        \PY{k+kn}{from} \PY{n+nn}{math} \PY{k}{import} \PY{n}{cos}\PY{p}{,} \PY{n}{sin}\PY{p}{,} \PY{n}{pi} 
        ...
        \PY{k}{def} \PY{n+nf}{to\PYZus{}homog}\PY{p}{(}\PY{n}{points}\PY{p}{)}\PY{p}{:}
            ...
            \PY{c+c1}{\PYZsh{} missing lambda}
            \PY{n}{col} \PY{o}{=} \PY{n}{points}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{n}{b} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{ones}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{col}\PY{p}{)}\PY{p}{)}
            \PY{n}{homo\PYZus{}1} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{vstack}\PY{p}{(}\PY{p}{(}\PY{n}{points}\PY{p}{,}\PY{n}{b}\PY{p}{)} \PY{p}{)}
            \PY{k}{return} \PY{n}{homo\PYZus{}1}
        
        \PY{c+c1}{\PYZsh{} convert points from homogeneous to euclidian}
        \PY{k}{def} \PY{n+nf}{from\PYZus{}homog}\PY{p}{(}\PY{n}{hm}\PY{p}{)}\PY{p}{:}
            \PY{c+c1}{\PYZsh{} write your code here  }
            \PY{n}{l} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{hm}\PY{p}{)}
            \PY{n}{col} \PY{o}{=} \PY{n}{hm}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{k}{if} \PY{n}{l} \PY{o}{==} \PY{l+m+mi}{3} \PY{o+ow}{or} \PY{n}{l} \PY{o}{==} \PY{l+m+mi}{4}\PY{p}{:}
                \PY{n}{Euc} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{hm}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{col}\PY{p}{)}\PY{p}{)}
                \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{col}\PY{p}{)}\PY{p}{:}
                
                    \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{hm}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:}
                        \PY{n}{Euc}\PY{p}{[}\PY{n}{i}\PY{p}{,}\PY{n}{j}\PY{p}{]} \PY{o}{=} \PY{n}{hm}\PY{p}{[}\PY{n}{i}\PY{p}{,}\PY{n}{j}\PY{p}{]}\PY{o}{/}\PY{n}{hm}\PY{p}{[}\PY{n}{l}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{j}\PY{p}{]}
                \PY{k}{return} \PY{n}{Euc}
        
            \PY{k}{else}\PY{p}{:}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Dimension wrong}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        ...
        \PY{k}{def} \PY{n+nf}{project\PYZus{}points}\PY{p}{(}\PY{n}{P\PYZus{}int}\PY{p}{,} \PY{n}{P\PYZus{}ext}\PY{p}{,} \PY{n}{pts}\PY{p}{)}\PY{p}{:}
            \PY{c+c1}{\PYZsh{} write your code here}
            \PY{c+c1}{\PYZsh{}eye = np.eye(4)}
            \PY{n}{col} \PY{o}{=} \PY{n}{pts}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{n}{b} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{ones}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{col}\PY{p}{)}\PY{p}{)}
            \PY{c+c1}{\PYZsh{}np.array([[1, 1, 1, 1]])}
            \PY{n}{pts} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{vstack}\PY{p}{(}\PY{p}{(}\PY{n}{pts}\PY{p}{,}\PY{n}{b}\PY{p}{)} \PY{p}{)}
            \PY{n}{a} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{P\PYZus{}int}\PY{p}{,}\PY{n}{P\PYZus{}ext}\PY{p}{)}
            \PY{c+c1}{\PYZsh{}b = np.dot(P\PYZus{}ext,pts)}
            \PY{n}{Euc\PYZus{}3D} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{a}\PY{p}{,}\PY{n}{pts}\PY{p}{)}
            \PY{n}{Euc\PYZus{}2D} \PY{o}{=} \PY{n}{from\PYZus{}homog}\PY{p}{(}\PY{n}{Euc\PYZus{}3D}\PY{p}{)}
            \PY{k}{return} \PY{n}{Euc\PYZus{}2D}
        ...
        \PY{c+c1}{\PYZsh{} Taylor Center ??????!!!!!!??!?!?!?!?!?!?!?!?!?!}
        \PY{n}{TC} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{]}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{T}
        ...
        \PY{k}{def} \PY{n+nf}{camera1}\PY{p}{(}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{P\PYZus{}int\PYZus{}proj}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{]} \PY{o}{=} \PY{l+m+mi}{1}\PY{o}{/}\PY{n}{f}
            ...
            \PY{n}{TC} \PY{o}{=} \PY{n}{from\PYZus{}homog}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{P\PYZus{}ext}\PY{p}{,}\PY{n}{to\PYZus{}homog}\PY{p}{(}\PY{n}{TC}\PY{p}{)}\PY{p}{)}\PY{p}{)}
            \PY{n}{x0} \PY{o}{=} \PY{n}{TC}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
            \PY{n}{y0} \PY{o}{=} \PY{n}{TC}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{n}{z0} \PY{o}{=} \PY{n}{TC}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}
            \PY{n}{P\PYZus{}int\PYZus{}affine} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{n}{f}\PY{o}{/}\PY{n}{z0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{n}{f}\PY{o}{*}\PY{n}{x0}\PY{o}{/}\PY{n}{z0}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{f}\PY{o}{*}\PY{n}{x0}\PY{o}{/}\PY{n}{z0}\PY{p}{]}\PY{p}{,} 
                                     \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{n}{f}\PY{o}{/}\PY{n}{z0}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{n}{f}\PY{o}{*}\PY{n}{y0}\PY{o}{/}\PY{n}{z0}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{f}\PY{o}{*}\PY{n}{y0}\PY{o}{/}\PY{n}{z0}\PY{p}{]}\PY{p}{,} 
        ...
        \PY{k}{def} \PY{n+nf}{camera2}\PY{p}{(}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{}no rotaion }
            \PY{c+c1}{\PYZsh{} write your code here}
            ...
            \PY{n}{P\PYZus{}int\PYZus{}affine} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{eye}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}
            \PY{n}{P\PYZus{}ext} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{eye}\PY{p}{(}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}
            \PY{n}{P\PYZus{}ext}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{:}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{:}\PY{p}{]} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{T}
            \PY{n}{TC} \PY{o}{=} \PY{n}{from\PYZus{}homog}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{P\PYZus{}ext}\PY{p}{,}\PY{n}{to\PYZus{}homog}\PY{p}{(}\PY{n}{TC}\PY{p}{)}\PY{p}{)}\PY{p}{)}
            \PY{n}{x0} \PY{o}{=} \PY{n}{TC}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
            \PY{n}{y0} \PY{o}{=} \PY{n}{TC}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{n}{z0} \PY{o}{=} \PY{n}{TC}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}
        ...
        \PY{k}{def} \PY{n+nf}{camera3}\PY{p}{(}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{P\PYZus{}int\PYZus{}affine} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{eye}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}
            \PY{n}{P\PYZus{}ext} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{eye}\PY{p}{(}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}
            \PY{c+c1}{\PYZsh{}60 \PYZhy{}\PYZhy{}pi/3  30 \PYZhy{}\PYZhy{}pi/6}
            \PY{n}{R\PYZus{}AB} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{n}{cos}\PY{p}{(}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{n}{sin}\PY{p}{(}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{]}\PY{p}{,} 
                             \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} 
                             \PY{p}{[}\PY{o}{\PYZhy{}}\PY{n}{sin}\PY{p}{(}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{n}{cos}\PY{p}{(}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{]}\PY{p}{]}\PY{p}{)}
            \PY{n}{R\PYZus{}BC} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{n}{cos}\PY{p}{(}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{n}{sin}\PY{p}{(}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} 
                             \PY{p}{[}\PY{n}{sin}\PY{p}{(}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{,} \PY{n}{cos}\PY{p}{(}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} 
                             \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{]}\PY{p}{)}
            \PY{n}{P\PYZus{}ext}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{:}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{:}\PY{l+m+mi}{3}\PY{p}{]} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{R\PYZus{}AB}\PY{p}{,}\PY{n}{R\PYZus{}BC}\PY{p}{)}   \PY{c+c1}{\PYZsh{}ROTATION MATRIX}
            \PY{n}{P\PYZus{}ext}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{:}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{:}\PY{p}{]} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{T}    \PY{c+c1}{\PYZsh{}TRANSLATION MATRIX [0,0,1].T}
            \PY{n}{TC} \PY{o}{=} \PY{n}{from\PYZus{}homog}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{P\PYZus{}ext}\PY{p}{,}\PY{n}{to\PYZus{}homog}\PY{p}{(}\PY{n}{TC}\PY{p}{)}\PY{p}{)}\PY{p}{)}
            \PY{n}{x0} \PY{o}{=} \PY{n}{TC}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
            \PY{n}{y0} \PY{o}{=} \PY{n}{TC}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{n}{z0} \PY{o}{=} \PY{n}{TC}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}
        ...
        \PY{k}{def} \PY{n+nf}{camera4}\PY{p}{(}\PY{p}{)}\PY{p}{:}    
            ...
            \PY{n}{R\PYZus{}BC} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{n}{cos}\PY{p}{(}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{n}{sin}\PY{p}{(}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} 
                             ...
                             \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{]}\PY{p}{)}
            \PY{n}{P\PYZus{}ext}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{:}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{:}\PY{l+m+mi}{3}\PY{p}{]} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{R\PYZus{}AB}\PY{p}{,}\PY{n}{R\PYZus{}BC}\PY{p}{)}   \PY{c+c1}{\PYZsh{}ROTATION MATRIX}
            \PY{n}{P\PYZus{}ext}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{:}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{:}\PY{p}{]} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{13}\PY{p}{]}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{T}    \PY{c+c1}{\PYZsh{}TRANSLATION MATRIX [0,0,1].T}
            \PY{n}{TC} \PY{o}{=} \PY{n}{from\PYZus{}homog}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{P\PYZus{}ext}\PY{p}{,}\PY{n}{to\PYZus{}homog}\PY{p}{(}\PY{n}{TC}\PY{p}{)}\PY{p}{)}\PY{p}{)}
            \PY{n}{x0} \PY{o}{=} \PY{n}{TC}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
            \PY{n}{y0} \PY{o}{=} \PY{n}{TC}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{n}{z0} \PY{o}{=} \PY{n}{TC}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}
        ...
        \PY{k}{def} \PY{n+nf}{main}\PY{p}{(}\PY{p}{)}\PY{p}{:}
            ...
            \PY{k}{for} \PY{n}{i}\PY{p}{,} \PY{n}{camera} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{p}{[}\PY{n}{camera1}\PY{p}{,} \PY{n}{camera2}\PY{p}{,} \PY{n}{camera3}\PY{p}{,} \PY{n}{camera4}\PY{p}{]}\PY{p}{)}\PY{p}{:}
                ...
                \PY{n}{plot\PYZus{}points}\PY{p}{(}\PY{n}{project\PYZus{}points}\PY{p}{(}\PY{n}{P\PYZus{}int\PYZus{}proj}\PY{p}{,} \PY{n}{P\PYZus{}ext}\PY{p}{,} \PY{n}{points}\PY{p}{)}\PY{p}{,} \PY{n}{title}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Camera }\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{ Projective}\PY{l+s+s1}{\PYZsq{}}\PY{o}{\PYZpc{}}\PY{p}{(}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mf}{0.75}\PY{p}{,}\PY{l+m+mf}{2.3}\PY{p}{,}\PY{o}{\PYZhy{}}\PY{l+m+mf}{0.75}\PY{p}{,}\PY{l+m+mf}{0.75}\PY{p}{]}\PY{p}{)}
                \PY{n}{plt}\PY{o}{.}\PY{n}{subplot}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}
                \PY{n}{plot\PYZus{}points}\PY{p}{(}\PY{n}{project\PYZus{}points}\PY{p}{(}\PY{n}{P\PYZus{}int\PYZus{}affine}\PY{p}{,} \PY{n}{P\PYZus{}ext}\PY{p}{,} \PY{n}{points}\PY{p}{)}\PY{p}{,} \PY{n}{title}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Camera }\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{ Affine}\PY{l+s+s1}{\PYZsq{}}\PY{o}{\PYZpc{}}\PY{p}{(}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mf}{0.75}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{o}{\PYZhy{}}\PY{l+m+mf}{0.75}\PY{p}{,}\PY{l+m+mf}{0.75}\PY{p}{]}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np}
        \PY{k+kn}{from} \PY{n+nn}{scipy}\PY{n+nn}{.}\PY{n+nn}{misc} \PY{k}{import} \PY{n}{imread}\PY{p}{,} \PY{n}{imresize}
        ...
        \PY{n}{source\PYZus{}image} \PY{o}{=} \PY{n}{imresize}\PY{p}{(}\PY{n}{imread}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{/Users/zhangbowen/Desktop/CSE252A/HW/HW1/HW1/photo.jpg}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{,}\PY{o}{.}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{l+m+mi}{3}\PY{p}{]}\PY{o}{/}\PY{l+m+mf}{255.}
        ...
        \PY{n}{x\PYZus{}coords} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{11}\PY{p}{,}\PY{l+m+mi}{45}\PY{p}{,}\PY{l+m+mi}{148}\PY{p}{,}\PY{l+m+mi}{140}\PY{p}{]} 
        \PY{n}{y\PYZus{}coords} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{195}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{,}\PY{l+m+mi}{50}\PY{p}{,}\PY{l+m+mi}{193}\PY{p}{]}
...
Use ``skimage.transform.resize`` instead.
  \# Remove the CWD from sys.path while we load stuff.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{def} \PY{n+nf}{computeH}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{y}\PY{p}{)}\PY{p}{:}
            \PY{c+c1}{\PYZsh{}x = source\PYZus{}points | y = target\PYZus{}points}
            \PY{c+c1}{\PYZsh{} returns the 3x3 homography matrix such that:}
            \PY{c+c1}{\PYZsh{} np.matmul(H, source\PYZus{}points) \PYZsh{}\PYZti{} target\PYZus{}points}
            \PY{c+c1}{\PYZsh{} where source\PYZus{}points and target\PYZus{}points are expected to be in homogeneous}
            \PY{c+c1}{\PYZsh{}x1\PYZhy{}\PYZhy{}x[0,i]}
            \PY{c+c1}{\PYZsh{}y1\PYZhy{}\PYZhy{}x[1,i]}
            \PY{c+c1}{\PYZsh{}x\PYZsq{}\PYZhy{}\PYZhy{}y[0,i]}
            \PY{c+c1}{\PYZsh{}y\PYZsq{}\PYZhy{}\PYZhy{}y[1,i]}
            \PY{n}{A} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{8}\PY{p}{,}\PY{l+m+mi}{9}\PY{p}{)}\PY{p}{)}
            \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range} \PY{p}{(}\PY{l+m+mi}{4}\PY{p}{)}\PY{p}{:}
                \PY{n}{xi} \PY{o}{=} \PY{n}{x}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{i}\PY{p}{]}
                \PY{n}{yi} \PY{o}{=} \PY{n}{x}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{i}\PY{p}{]}
                \PY{n}{x\PYZus{}dot} \PY{o}{=} \PY{n}{y}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{i}\PY{p}{]}
                \PY{n}{y\PYZus{}dot} \PY{o}{=} \PY{n}{y}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{i}\PY{p}{]}        
                \PY{n}{A}\PY{p}{[}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{i}\PY{p}{,}\PY{p}{:}\PY{p}{]} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{n}{xi}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{n}{yi}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{y\PYZus{}dot}\PY{o}{*}\PY{n}{xi}\PY{p}{,} \PY{n}{y\PYZus{}dot}\PY{o}{*}\PY{n}{yi}\PY{p}{,} \PY{n}{y\PYZus{}dot}\PY{p}{]}\PY{p}{)} 
                \PY{n}{A}\PY{p}{[}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{,}\PY{p}{:}\PY{p}{]} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{n}{xi}\PY{p}{,} \PY{n}{yi}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{n}{xi}\PY{o}{*}\PY{n}{x\PYZus{}dot}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{n}{x\PYZus{}dot}\PY{o}{*}\PY{n}{yi}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{n}{x\PYZus{}dot}\PY{p}{]}\PY{p}{)}
            ...
            \PY{n}{H} \PY{o}{=} \PY{n}{vh}\PY{p}{[}\PY{l+m+mi}{8}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{]}\PY{o}{.}\PY{n}{T}             
            ...
            \PY{k}{assert} \PY{n}{x}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{==}\PY{l+m+mi}{3} \PY{o+ow}{and} \PY{n}{y}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{==}\PY{l+m+mi}{3}
...
The red and blue quadrilaterals should overlap if ComputeH is implemented correctly.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{k}{def} \PY{n+nf}{warp}\PY{p}{(}\PY{n}{source\PYZus{}img}\PY{p}{,} \PY{n}{source\PYZus{}points}\PY{p}{,} \PY{n}{target\PYZus{}size}\PY{p}{)}\PY{p}{:}
            ...
            \PY{c+c1}{\PYZsh{}T = np.zeros((target\PYZus{}size))}
            \PY{c+c1}{\PYZsh{}T = np.ones((5,5),np.uint8)}
            \PY{n}{x} \PY{o}{=} \PY{n}{target\PYZus{}size}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
            \PY{n}{y} \PY{o}{=} \PY{n}{target\PYZus{}size}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{n}{x\PYZus{}start} \PY{o}{=} \PY{l+m+mi}{10}
            \PY{n}{y\PYZus{}start} \PY{o}{=} \PY{l+m+mi}{10}
            \PY{n}{T} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{n}{y}\PY{o}{+}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{y\PYZus{}start}\PY{o}{+}\PY{l+m+mi}{50}\PY{p}{,}\PY{n}{x}\PY{o}{+}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{x\PYZus{}start}\PY{o}{+}\PY{l+m+mi}{50}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{)} 
            \PY{n}{target\PYZus{}points} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{n}{x\PYZus{}start}\PY{p}{,} \PY{n}{x\PYZus{}start}\PY{p}{,} \PY{n}{x\PYZus{}start}\PY{o}{+}\PY{n}{x}\PY{p}{,} \PY{n}{x\PYZus{}start}\PY{o}{+}\PY{n}{x}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{n}{y\PYZus{}start}\PY{o}{+}\PY{n}{y}\PY{p}{,} \PY{n}{y\PYZus{}start}\PY{p}{,} \PY{n}{y\PYZus{}start}\PY{p}{,} \PY{n}{y\PYZus{}start}\PY{o}{+}\PY{n}{y}\PY{p}{]}\PY{p}{]}\PY{p}{)}
            \PY{n}{H} \PY{o}{=} \PY{n}{computeH}\PY{p}{(}\PY{n}{to\PYZus{}homog}\PY{p}{(}\PY{n}{source\PYZus{}points}\PY{p}{)}\PY{p}{,} \PY{n}{to\PYZus{}homog}\PY{p}{(}\PY{n}{target\PYZus{}points}\PY{p}{)}\PY{p}{)}
            \PY{n}{xx} \PY{o}{=} \PY{n}{source\PYZus{}img}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{n}{yy} \PY{o}{=} \PY{n}{source\PYZus{}img}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
            \PY{c+c1}{\PYZsh{}mapped\PYZus{}points = np.zeros((xx,yy))}
            \PY{n}{mapped\PYZus{}points} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
            \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range} \PY{p}{(}\PY{n}{xx}\PY{p}{)}\PY{p}{:}
                \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{yy}\PY{p}{)}\PY{p}{:}
                    \PY{n}{p} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{]}\PY{p}{)}    
                    \PY{n}{mapped\PYZus{}points} \PY{o}{=} \PY{n}{from\PYZus{}homog}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{matmul}\PY{p}{(}\PY{n}{H}\PY{p}{,}\PY{n}{to\PYZus{}homog}\PY{p}{(}\PY{n}{p}\PY{p}{)}\PY{p}{)}\PY{p}{)} 
                    \PY{n}{T}\PY{p}{[}\PY{n+nb}{int}\PY{p}{(}\PY{n}{mapped\PYZus{}points}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{,}\PY{n+nb}{int}\PY{p}{(}\PY{n}{mapped\PYZus{}points}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{]} \PY{o}{=} \PY{n}{source\PYZus{}img}\PY{p}{[}\PY{n}{j}\PY{p}{,}\PY{n}{i}\PY{p}{]}
            
        
            \PY{n}{T\PYZus{}hat} \PY{o}{=} \PY{n}{T}\PY{p}{[}\PY{n}{y\PYZus{}start}\PY{p}{:} \PY{n}{y}\PY{o}{+}\PY{n}{y\PYZus{}start}\PY{p}{,} \PY{n}{x\PYZus{}start}\PY{p}{:} \PY{n}{x}\PY{o}{+}\PY{n}{x\PYZus{}start}\PY{p}{]}
            \PY{k}{return} \PY{n}{T\PYZus{}hat}
        \PY{c+c1}{\PYZsh{} Use the code below to plot your result}
        \PY{n}{result} \PY{o}{=} \PY{n}{warp}\PY{p}{(}\PY{n}{source\PYZus{}image}\PY{p}{,} \PY{n}{source\PYZus{}points}\PY{p}{,} \PY{p}{(}\PY{l+m+mi}{150}\PY{p}{,}\PY{l+m+mi}{200}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{subplot}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{source\PYZus{}image}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{subplot}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}
...
and fill in the target image.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{k+kn}{from} \PY{n+nn}{numpy}\PY{n+nn}{.}\PY{n+nn}{linalg} \PY{k}{import} \PY{n}{inv}
        \PY{k}{def} \PY{n+nf}{warp2}\PY{p}{(}\PY{n}{source\PYZus{}img}\PY{p}{,} \PY{n}{source\PYZus{}points}\PY{p}{,} \PY{n}{target\PYZus{}size}\PY{p}{)}\PY{p}{:}
            ...
            \PY{c+c1}{\PYZsh{} Make sure the new image (of size target\PYZus{}size) has the same number of color channels as source image}
            \PY{n}{y} \PY{o}{=} \PY{n}{target\PYZus{}size}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
            \PY{n}{x} \PY{o}{=} \PY{n}{target\PYZus{}size}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{n}{x\PYZus{}start} \PY{o}{=} \PY{l+m+mi}{100}  \PY{c+c1}{\PYZsh{}1000}
            \PY{n}{y\PYZus{}start} \PY{o}{=} \PY{l+m+mi}{100}  \PY{c+c1}{\PYZsh{}1300 }
            \PY{n}{T} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{n}{y}\PY{o}{+}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{y\PYZus{}start}\PY{o}{+}\PY{l+m+mi}{50}\PY{p}{,}\PY{n}{x}\PY{o}{+}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{x\PYZus{}start}\PY{o}{+}\PY{l+m+mi}{50}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{)} 
            \PY{n}{target\PYZus{}points} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{n}{x\PYZus{}start}\PY{p}{,} \PY{n}{x\PYZus{}start}\PY{p}{,} \PY{n}{x\PYZus{}start}\PY{o}{+}\PY{n}{x}\PY{p}{,} \PY{n}{x\PYZus{}start}\PY{o}{+}\PY{n}{x}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{n}{y\PYZus{}start}\PY{o}{+}\PY{n}{y}\PY{p}{,} \PY{n}{y\PYZus{}start}\PY{p}{,} \PY{n}{y\PYZus{}start}\PY{p}{,} \PY{n}{y\PYZus{}start}\PY{o}{+}\PY{n}{y}\PY{p}{]}\PY{p}{]}\PY{p}{)}
            \PY{n}{H} \PY{o}{=} \PY{n}{computeH}\PY{p}{(}\PY{n}{to\PYZus{}homog}\PY{p}{(}\PY{n}{source\PYZus{}points}\PY{p}{)}\PY{p}{,} \PY{n}{to\PYZus{}homog}\PY{p}{(}\PY{n}{target\PYZus{}points}\PY{p}{)}\PY{p}{)}
            \PY{n}{H\PYZus{}inv} \PY{o}{=} \PY{n}{inv}\PY{p}{(}\PY{n}{H}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{}xx = source\PYZus{}img.shape[1]}
            \PY{c+c1}{\PYZsh{}yy = source\PYZus{}img.shape[0]}
            \PY{c+c1}{\PYZsh{}mapped\PYZus{}points = np.zeros((xx,yy))}
            \PY{n}{mapped\PYZus{}points} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
            \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range} \PY{p}{(}\PY{n}{x\PYZus{}start}\PY{p}{,} \PY{n}{x}\PY{o}{+}\PY{n}{x\PYZus{}start}\PY{p}{)}\PY{p}{:}
                \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{y\PYZus{}start}\PY{p}{,} \PY{n}{y}\PY{o}{+}\PY{n}{y\PYZus{}start}\PY{p}{)}\PY{p}{:}
                    \PY{n}{p} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{]}\PY{p}{)}    
                    \PY{n}{mapped\PYZus{}points} \PY{o}{=} \PY{n}{from\PYZus{}homog}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{matmul}\PY{p}{(}\PY{n}{H\PYZus{}inv}\PY{p}{,}\PY{n}{to\PYZus{}homog}\PY{p}{(}\PY{n}{p}\PY{p}{)}\PY{p}{)}\PY{p}{)} 
                    
                    \PY{n}{T}\PY{p}{[}\PY{n}{j}\PY{p}{,}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{n}{source\PYZus{}img}\PY{p}{[}\PY{n+nb}{int}\PY{p}{(}\PY{n}{mapped\PYZus{}points}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{,}\PY{n+nb}{int}\PY{p}{(}\PY{n}{mapped\PYZus{}points}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{]}
...
document as the target.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{n}{source\PYZus{}image2} \PY{o}{=} \PY{n}{imread}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/Users/zhangbowen/Desktop/CSE252A/HW/HW1/HW1/ucsd\PYZus{}logo.png}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{p}{,}\PY{p}{:}\PY{l+m+mi}{3}\PY{p}{]}\PY{o}{/}\PY{l+m+mf}{255.}
        \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{source\PYZus{}image2}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{n}{source\PYZus{}image2}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
/Users/zhangbowen/anaconda3/lib/python3.6/site-packages/ipykernel\_launcher.py:1: DeprecationWarning: `imread` is deprecated!
`imread` is deprecated in SciPy 1.0.0, and will be removed in 1.2.0.
Use ``imageio.imread`` instead.
...
(200, 200, 3)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{\PYZsh{} Load the given UCSD logo image}
        \PY{k}{def} \PY{n+nf}{inside\PYZus{}polygon}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{n}{points}\PY{p}{)}\PY{p}{:}
            \PY{n}{n} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{points}\PY{p}{)}
            \PY{n}{inside} \PY{o}{=} \PY{k+kc}{False}
            \PY{n}{p1x}\PY{p}{,} \PY{n}{p1y} \PY{o}{=} \PY{n}{points}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
            \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{n} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:}
                \PY{n}{p2x}\PY{p}{,} \PY{n}{p2y} \PY{o}{=} \PY{n}{points}\PY{p}{[}\PY{n}{i} \PY{o}{\PYZpc{}} \PY{n}{n}\PY{p}{]}
                \PY{k}{if} \PY{n}{y} \PY{o}{\PYZgt{}} \PY{n+nb}{min}\PY{p}{(}\PY{n}{p1y}\PY{p}{,} \PY{n}{p2y}\PY{p}{)}\PY{p}{:}
                    \PY{k}{if} \PY{n}{y} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{n+nb}{max}\PY{p}{(}\PY{n}{p1y}\PY{p}{,} \PY{n}{p2y}\PY{p}{)}\PY{p}{:}
                        \PY{k}{if} \PY{n}{x} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{n+nb}{max}\PY{p}{(}\PY{n}{p1x}\PY{p}{,} \PY{n}{p2x}\PY{p}{)}\PY{p}{:}
                            \PY{k}{if} \PY{n}{p1y} \PY{o}{!=} \PY{n}{p2y}\PY{p}{:}
                                \PY{n}{xinters} \PY{o}{=} \PY{p}{(}\PY{n}{y} \PY{o}{\PYZhy{}} \PY{n}{p1y}\PY{p}{)} \PY{o}{*} \PY{p}{(}\PY{n}{p2x} \PY{o}{\PYZhy{}} \PY{n}{p1x}\PY{p}{)} \PY{o}{/} \PY{p}{(}\PY{n}{p2y} \PY{o}{\PYZhy{}} \PY{n}{p1y}\PY{p}{)} \PY{o}{+} \PY{n}{p1x}
                            \PY{k}{if} \PY{n}{p1x} \PY{o}{==} \PY{n}{p2x} \PY{o+ow}{or} \PY{n}{x} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{n}{xinters}\PY{p}{:}
                                \PY{n}{inside} \PY{o}{=} \PY{o+ow}{not} \PY{n}{inside}
                \PY{n}{p1x}\PY{p}{,} \PY{n}{p1y} \PY{o}{=} \PY{n}{p2x}\PY{p}{,} \PY{n}{p2y}
        ...
        \PY{k}{def} \PY{n+nf}{warp3}\PY{p}{(}\PY{n}{target\PYZus{}image}\PY{p}{,} \PY{n}{target\PYZus{}points}\PY{p}{,} \PY{n}{source\PYZus{}image}\PY{p}{)}\PY{p}{:}
            \PY{k}{pass}    
            \PY{n}{x} \PY{o}{=} \PY{n}{source\PYZus{}image}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{n}{y} \PY{o}{=} \PY{n}{source\PYZus{}image}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
            \PY{n}{xx} \PY{o}{=} \PY{n}{target\PYZus{}image}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{n}{yy} \PY{o}{=} \PY{n}{target\PYZus{}image}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
            \PY{n}{x\PYZus{}start} \PY{o}{=} \PY{l+m+mi}{0}
            \PY{n}{y\PYZus{}start} \PY{o}{=} \PY{l+m+mi}{0}
            \PY{n}{Extend\PYZus{}image} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{ones}\PY{p}{(}\PY{p}{(}\PY{n}{y}\PY{o}{+}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{y\PYZus{}start}\PY{o}{+}\PY{l+m+mi}{100}\PY{p}{,}\PY{n}{x}\PY{o}{+}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{x\PYZus{}start}\PY{o}{+}\PY{l+m+mi}{100}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{}add logo to a black background}
            \PY{n}{Extend\PYZus{}image}\PY{p}{[}\PY{n}{y\PYZus{}start}\PY{p}{:}\PY{n}{y}\PY{o}{+}\PY{n}{y\PYZus{}start} \PY{p}{,} \PY{n}{x\PYZus{}start}\PY{p}{:}\PY{n}{x}\PY{o}{+}\PY{n}{x\PYZus{}start}\PY{p}{]} \PY{o}{=} \PY{n}{source\PYZus{}image}
            \PY{n}{ucsd\PYZus{}pts} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{n}{x\PYZus{}start}\PY{p}{,} \PY{n}{x\PYZus{}start}\PY{p}{,} \PY{n}{x\PYZus{}start}\PY{o}{+}\PY{n}{x}\PY{p}{,} \PY{n}{x\PYZus{}start}\PY{o}{+}\PY{n}{x}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{n}{y\PYZus{}start}\PY{o}{+}\PY{n}{y}\PY{p}{,} \PY{n}{y\PYZus{}start}\PY{p}{,} \PY{n}{y\PYZus{}start}\PY{p}{,} \PY{n}{y\PYZus{}start}\PY{o}{+}\PY{n}{y}\PY{p}{]}\PY{p}{]}\PY{p}{)}
            \PY{c+c1}{\PYZsh{}H\PYZus{}inv = inv(H)}
            \PY{n}{H} \PY{o}{=} \PY{n}{computeH}\PY{p}{(}\PY{n}{to\PYZus{}homog}\PY{p}{(}\PY{n}{target\PYZus{}points}\PY{p}{)}\PY{p}{,} \PY{n}{to\PYZus{}homog}\PY{p}{(}\PY{n}{ucsd\PYZus{}pts}\PY{p}{)}\PY{p}{)}
            \PY{n}{zeros} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{)}
            \PY{n}{mask} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{ones}\PY{p}{(}\PY{p}{(}\PY{n}{target\PYZus{}image}\PY{o}{.}\PY{n}{shape}\PY{p}{)}\PY{p}{)}
            \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range} \PY{p}{(}\PY{n}{xx}\PY{p}{)}\PY{p}{:}
                \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{yy}\PY{p}{)}\PY{p}{:}
                    \PY{k}{if} \PY{n}{inside\PYZus{}polygon}\PY{p}{(}\PY{n}{i}\PY{p}{,} \PY{n}{j}\PY{p}{,} \PY{n}{source\PYZus{}points}\PY{o}{.}\PY{n}{T}\PY{p}{)} \PY{o}{==} \PY{k+kc}{True}\PY{p}{:}
                        \PY{n}{p} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{]}\PY{p}{)}  
                        \PY{n}{mapped\PYZus{}points} \PY{o}{=} \PY{n}{from\PYZus{}homog}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{matmul}\PY{p}{(}\PY{n}{H}\PY{p}{,}\PY{n}{to\PYZus{}homog}\PY{p}{(}\PY{n}{p}\PY{p}{)}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{}logo to polygon}
                        \PY{n}{mask}\PY{p}{[}\PY{n}{j}\PY{p}{,}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{n}{Extend\PYZus{}image}\PY{p}{[}\PY{n+nb}{int}\PY{p}{(}\PY{n}{mapped\PYZus{}points}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{,}\PY{n+nb}{int}\PY{p}{(}\PY{n}{mapped\PYZus{}points}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{]} \PY{c+c1}{\PYZsh{}black background tilted logo | target size}
                        \PY{n}{target\PYZus{}image}\PY{p}{[}\PY{n}{j}\PY{p}{,}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{n}{zeros}
        
            \PY{c+c1}{\PYZsh{}New\PYZus{}target = cv2.add(target\PYZus{}image,mask)}
            \PY{n}{New\PYZus{}target} \PY{o}{=} \PY{n}{target\PYZus{}image} \PY{o}{+} \PY{n}{mask}
            
            \PY{k}{return} \PY{n}{New\PYZus{}target}
        
        \PY{c+c1}{\PYZsh{} Use the code below to plot your result}
        \PY{n}{New\PYZus{}target} \PY{o}{=} \PY{n}{warp3}\PY{p}{(}\PY{n}{source\PYZus{}image}\PY{p}{,} \PY{n}{source\PYZus{}points}\PY{p}{,} \PY{n}{source\PYZus{}image2}\PY{p}{)}
        
        \PY{n}{plt}\PY{o}{.}\PY{n}{subplot}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{source\PYZus{}image2}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{subplot}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{New\PYZus{}target}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
